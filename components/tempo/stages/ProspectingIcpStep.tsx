          ...
          <div className="px-md py-md space-y-lg">
            <section className="space-y-sm">
              ...
              <textarea
                ...
                className="w-full p-md bg-surface border border-outline-variant rounded-lg focus:ring-2 focus:ring-secondary-container focus:border-secondary focus:outline-none font-body-md resize-y"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-md">
                <div>
                  ...
                  <input
                    ...
                    min={1}
                    inputMode="numeric"
                    className="w-full bg-surface border border-outline-variant rounded-lg focus:ring-2 focus:ring-secondary p-md font-body-md"
                    placeholder="e.g. 2"
