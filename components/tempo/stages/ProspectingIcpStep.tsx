...
export function ProspectingIcpStep({
  ...
  return (
    <div className="w-full h-full min-h-full flex flex-col">
      <div className="flex flex-1 flex-col bg-white rounded-xl border border-outline-variant shadow-sm overflow-hidden min-h-0">
        <div className="px-lg lg:px-xl py-lg border-b border-outline-variant bg-surface-container-low shrink-0">
          <h1 className="font-headline-lg text-headline-lg text-primary">Ideal Customer Profile</h1>
        </div>

        <div className="flex-1 overflow-y-auto p-lg lg:p-xl space-y-xl">
          <section className="space-y-sm">
            <div className="flex justify-between items-center">
              <label
                className="font-bold text-label-md text-on-surface"
                htmlFor="icp-target-verticals"
              >
                Target verticals
              </label>
          ...
          {state.icpTargetVerticals.trim() ? (
            <div className="p-lg rounded-lg border border-outline-variant bg-surface-container-low">
